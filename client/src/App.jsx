...
import { useFooterVisibility } from './components/hooks/useFooterVisibility'; // ✅ ADD THIS
...
// ✅ ADD THIS - Layout component inside Router
function AppLayout() {
  const showFooter = useFooterVisibility(); // ✅ USE THE HOOK
  ...
  return (
    <div className="App">
      ...
      {/* ✅ CONDITIONAL FOOTER - Only shows when it should */}
      {showFooter && <Footer />}
    </div>
  );
}

// ✅ UPDATE THIS - Main App component
function App() {
  return (
    <AuthProvider>
      <Router>
        <AppLayout />  {/* ✅ USE LAYOUT COMPONENT */}
      </Router>
    </AuthProvider>
  );
}
